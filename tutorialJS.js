$(document).ready(()=>{ // jQuery main
    ...
    function draw() {
        ...
        text1.text = 'Nice to meet you, player.\n\nExit is almost there.';
        text1.font = '25px Zpix';
        text2.text = 'Move：Press A or D\n\nHint：Help the robots,\n\n　　 　and they will help you.\n\n\n　 　　SAVE and LOAD\n\n　　　 whenever you need.\n\n\nDON\'T DESTROY ANYONE OR ANYTHING.';
        text2.font = '25px Zpix';
        text2.color = '#FFFFFF'
